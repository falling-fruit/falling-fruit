...
Translations for Falling Fruit are managed on [Locale](http://www.localeapp.com/). 
To contribute, edit the translations directly on the
[falling-fruit](http://www.localeapp.com/projects/public?search=falling-fruit)
project on Locale. We will then pull translations from the Locale project and push to Github.
Happy translating!
